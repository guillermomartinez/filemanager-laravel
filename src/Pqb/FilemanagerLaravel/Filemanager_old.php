...
class Filemanager
{
	...
	public $connector_url='/filemanager/connectors';

	public function __construct($extraConfig = '') {		
		// getting default config file
		$content = file_get_contents(public_path()."/filemanager/scripts/filemanager.config.js.default");
...
public function run()
{
require dirname(__FILE__).'/inc/filemanager.inc.php';
// require dirname(__FILE__).'./inc/filemanager.class.php';
